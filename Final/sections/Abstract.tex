...
%
We show that our approaches can learn the complete rule from training corpus without any given constraints, and can generate elegant Song Ci poems that follow complex rules.
% 
